...
import { TrendingUp, Target, Globe, Zap, Clock } from 'lucide-react';
...
const COLOR_LIGHT_GRAY = '#F0F3F5'; // Lighter background
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-24 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 mb-3">
            <Clock className="w-5 h-5" style={{ color: COLOR_GOLD }} aria-hidden="true" />
          ...
          <p className="text-lg max-w-3xl mx-auto text-gray-700">
            Royal Sand’s two-phase strategy ensures rapid market penetration in Gujarat followed by sustainable expansion across neighboring states, maintaining product quality and supply assurance.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          >
            <div
              className="h-full bg-white rounded-3xl p-6 sm:p-8 shadow-xl transition-all duration-500 border-t-8 border-l-2"
              style={{ borderColor: COLOR_GOLD }}
            >
              {/* Header */}
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-0 mb-6">
                <div className="flex items-center gap-4">
                  <div className="relative">
                    ...
                    <div
                      className="absolute -top-1 -right-1 w-6 h-6 rounded-full flex items-center justify-center text-xs font-black text-white shadow-md"
              ...
              <p className="text-gray-700 mb-6 sm:mb-8 text-base leading-relaxed">
                Achieving <strong>full market penetration</strong> for M-sand, P-sand, and aggregates across Gujarat while optimizing supply chain logistics.
              </p>
          ...
          >
            ...
            >
              ...
              {/* Description */}
              <p className="text-gray-700 mb-6 sm:mb-8 text-base leading-relaxed">
                <strong>Geographical expansion</strong> into neighboring states and <strong>capacity scaling</strong> to support national infrastructure projects and RMC demands.
              </p>
